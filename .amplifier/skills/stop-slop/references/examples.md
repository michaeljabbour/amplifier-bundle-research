...
**Changes:** Single sentence. No performative emphasis. (Note: the original stop-slop skill says "no em-dashes"; if strictly followed, rewrite as "Speed, quality, cost: pick two.")
